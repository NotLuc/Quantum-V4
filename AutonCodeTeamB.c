...
void driveForward(int x){
	...
	while(rx>0||lx>0){
		...
		lx-=abs((SensorValue[leftDriveEnc]/1240)*(int)(3.1415926));
		rx-=abs((SensorValue[rightDriveEnc]/1240)*(int)(3.1415926));
	}
...
void driveBackwards(int x){
	...
	while(rx>0||lx>0){
		...
		rx-=abs((SensorValue[rightDriveEnc]/360)*(int)(3.1415926*(float)(4)));
	}
}
task auton()
{
